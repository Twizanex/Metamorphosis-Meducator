...
// File Locations
$rooturl            =   "http://{$_SERVER['HTTP_HOST']}/lime"; // The root web url for your limesurvey installation (without a trailing slash).
...
$defaultpass        =   'test';        // This is the password for the administration user when LimeSurvey is installed
