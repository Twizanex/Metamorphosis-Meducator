<?php
/**
 * File for AcccaWsdlClass to communicate with SOAP service
 * @package Accca
 ...
 * @date 09/04/2013
 */
class AcccaWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses AcccaWsdlClass::setLastError()
	 * @uses AcccaWsdlClass::initSoapClient()
	 * @uses AcccaWsdlClass::initInternArrayToIterate()
	 * @uses AcccaWsdlClass::_set()
	 ...
	 * @uses AcccaClassMap::classMap()
	 * @uses AcccaWsdlClass::getDefaultWsdlOptions()
	 * @uses AcccaWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('AcccaClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = AcccaClassMap::classMap();
	 ...
	 * @uses AcccaWsdlClass::WSDL_CACHE_WSDL
	 * @uses AcccaWsdlClass::WSDL_COMPRESSION
	 * @uses AcccaWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses AcccaWsdlClass::WSDL_ENCODING
	 * @uses AcccaWsdlClass::WSDL_EXCPTS
	 * @uses AcccaWsdlClass::WSDL_FEATURES
	 * @uses AcccaWsdlClass::WSDL_LOGIN
	 * @uses AcccaWsdlClass::WSDL_PASSWD
	 * @uses AcccaWsdlClass::WSDL_SOAP_VERSION
	 * @uses AcccaWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses AcccaWsdlClass::WSDL_TRACE
	 * @uses AcccaWsdlClass::WSDL_TYPEMAP
	 * @uses AcccaWsdlClass::WSDL_URL
	 * @uses AcccaWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses AcccaWsdlClass::getFormatedXml()
	 ...
	 * @uses AcccaWsdlClass::getInternArrayToIterate()
	 * @uses AcccaWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses AcccaWsdlClass::getInternArrayToIterateOffset()
	 * @uses AcccaWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses AcccaWsdlClass::getInternArrayToIterateOffset()
	 * @uses AcccaWsdlClass::offsetExists()
	 ...
	 * @uses AcccaWsdlClass::getAttributeName()
	 * @uses AcccaWsdlClass::__toString()
	 * @uses AcccaWsdlClass::_set()
	 * @uses AcccaWsdlClass::_get()
	 * @uses AcccaWsdlClass::setInternArrayToIterate()
	 * @uses AcccaWsdlClass::setInternArrayToIterateIsArray()
	 * @uses AcccaWsdlClass::setInternArrayToIterateOffset()
