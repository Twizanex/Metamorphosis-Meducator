<?php
	...
	$english = array(
		 ...
		 */
			...
			'PUBLIC' => "Public",
			'access:friends:label' => "Repurposed From",
			'access' => "Access",
...
To remove a widget drag it back to the <b>Widget gallery</b>.",
		 ...
		 */
			...
			'friend:add' => "Define as source object",
			'friend:remove' => "Remove from source obects",
	
			'friends:add:successful' => "You have successfully added %s as a source object.",
			'friends:add:failure' => "We couldn't add %s as a source object. Please try again.",
	
			'friends:remove:successful' => "You have successfully removed %s from your source objects.",
			'friends:remove:failure' => "We couldn't remove %s from your source objects. Please try again.",
	        ...
	        'friends:river:add' => "%s is now repurposed from",
...
You cannot reply to this email.",
		...
		/* 	----------------------------------
				...
				----------------------------------	*/
			'admin:contentItem:description' => "This admin panel allows you to add a new content item. Select the option below to get started.",					
			'admin:contentItem:addContentItem:label' => "Click here to add a new Content Item...",
			'addContentItem' => "Add Content Item",
			'createContentItem' => "Create Content Item",
			'newContentItem:label' => "New Content Item",
			//'admin:user' => "User Administration",
			'admin:user' => "User Administration",
			
			
			'profile:showgraph' => "Show Graph",
			'profile:showcontentitemlabel' => "Content Item Relationships",
			...
			'content_item_ok' => "You have successfully created a new content item.",
			'content_item_bad' => "The new content item could not be created.",
			'content_item_search' => "Search for parent content item",
