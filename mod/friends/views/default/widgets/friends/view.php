...
////////////CREATOR
				...
				if($result != null)
		{
			...
			//	echo "<b><font color=blue>DOWNLOAD RESOURCE <br></font></b>";

				
				if ($owner->meducator1)				
				echo "<b><a href=\"".$owner->meducator1."\">"."DOWNLOAD RESOURCE HERE"."</a></b>";
			...
			echo "<a href=\"http://metamorphosis.med.duth.gr/pg/profile/".get_user($nikolas)->username."\">".get_user($nikolas)->name."</a>";
			$ni = get_user($nikolas);
			if ($ni->Affiliation)
		{	$affil=get_user($nikolas)->Affiliation;
	//		$aff=implode(",",affil);
			echo"<br /> <b>Affiliation: </b>".$affil;}
			echo "</div>";
			...
			else
		{
			...
			$result4 = mysql_query($query4);						
												echo "<div class=\"contentWrapper\" style=\"height: 200px; overflow:auto;\" >";
