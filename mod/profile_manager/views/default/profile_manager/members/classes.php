...
class LearningResource {
	...
	public function insertMetadata($name, $value) {
		...
		include $IndexingClassificationPath. 'config.php';
...
class Cluster {
	...
	//it tells if an element is part of the cluster or not and returns the position (starting from 1, if not result can be confused with FALSE)
