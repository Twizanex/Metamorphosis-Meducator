<?php
	$polish = array(
		...
		/*Topbar texts*/
		'vazco_topbar:profile:icon' => 'Mój profil',
	
		/*Administration*/
		'vazco_mainpage:menu:short' => 'Gadżety strony głównej',
		'defaultwidgets:menu:dashboard:short' => 'Gadżety pulpitu',
		'defaultwidgets:menu:profile:short' => 'Gadżety profilu',
		'defaultwidgets:menu:user:short' => 'Użytkownicy',
		'defaultwidgets:menu:forms:short' => 'Formularze',
		'vazco_avatar:menu:short' => 'Awatary',
		'vazco_topbar:home' => 'Start',
	);
