...
$gent=get_entity($userid);
if (is_array($gent->meducator26))
$gent1=implode(",",$gent->meducator26);
else
$gent1=$gent->meducator26;
if ($gent->meducator26)
$name=$name1."\nRepurposing Context: ".$gent1;
else
$name=$name1;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	 
	...
	//	Create java applet for showing Graph
		...
		$ST .= "<div class=\"contentWrapper\">
					...
					<param name=INPUT_FILE value=\"http://metamorphosis.med.duth.gr/mod/content_item/".$file.".xml\"/>
					</applet>
			</div>";
