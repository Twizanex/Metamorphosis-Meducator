...
class GoogleMapAPI {
     ...
     * @var string
     */
    var $api_key = 'ABQIAAAAQNUInQTwgn5VDDyl8bOByxSM5HRgLZx_FTvWflhOcXW1FpA9rhSc6ancYc0NEjrJi8yIkmEMFXzv5Q';
    ...
    function addMarkerByAddress($address,$title = '',$html = '',$tooltip = '') {
        if(($_geocode = $this->getGeocode($address)) === false)
            return false;
		//return $this->addMarkerByCoords(10,5,"BlaBlaSTathis","<b>BlaBlaStathis</b>","This is Stathis tooltip");
