...
*************************************** */
#elgg_topbar {
	background:#333333 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/toptoolbar_background.gif) repeat-x top left;
	//*color:#eeeeee;*//
...
background:#333333 url(http://localhost/elgg/mod/custom_white_theme/graphics/toptoolbar_background.gif) repeat-x scroll left top;
...
.river_user_update {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_profile.gif) no-repeat left -1px;
}
...
.river_object_annotate {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_comment.gif) no-repeat left -1px;
}
.river_object_bookmarks_create {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_bookmarks.gif) no-repeat left -1px;
}
.river_object_bookmarks_comment {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_comment.gif) no-repeat left -1px;
}
.river_object_status_create {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_status.gif) no-repeat left -1px;
}
.river_object_file_create {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_files.gif) no-repeat left -1px;
}
...
.river_object_widget_create {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_plugin.gif) no-repeat left -1px;
}
.river_object_forums_create {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_forum.gif) no-repeat left -1px;
}
...
.river_object_blog_create {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_blog.gif) no-repeat left -1px;
}
...
.river_user_friend {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_friends.gif) no-repeat left -1px;
}
...
.river_object_thewire_create {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_thewire.gif) no-repeat left -1px;
}
.river_group_join {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_forum.gif) no-repeat left -1px;
}
...
.river_object_page_create {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/river_icons/river_icon_pages.gif) no-repeat left -1px;
}
...
#owner_block_rss_feed a {
	...
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/icon_rss.gif) no-repeat left top;
}
#owner_block_odd_feed a {
	font-size: 90%;
	color:#FFFFFF;
	padding:0 0 4px 20px;
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/icon_odd.gif) no-repeat left top;
}
#owner_block_bookmark_this a {
	font-size: 90%;
	color:#999999;
	padding:0 0 4px 20px;
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/icon_bookmarkthis.gif) no-repeat left top;
}
#owner_block_report_this a {
	font-size: 90%;
	color:#FFFFFF;
	padding:0 0 4px 20px;
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/icon_reportthis.gif) no-repeat left top;
}
...
.friendsPickerNavigationL {
	background: url("<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/friends_picker_arrows.gif") no-repeat left top;
}
.friendsPickerNavigationR {
	background: url("<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/friends_picker_arrows.gif") no-repeat -60px top;
}
.friendsPickerNavigationL:hover {
	background: url("<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/friends_picker_arrows.gif") no-repeat left -44px;
}
.friendsPickerNavigationR:hover {
	background: url("<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/friends_picker_arrows.gif") no-repeat -60px -44px;
}	
...
#customise_editpanel img.more_info {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/icon_customise_info.gif) no-repeat top left;
	cursor:pointer;
}
#customise_editpanel img.drag_handle {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/icon_customise_drag.gif) no-repeat top left;
	cursor:move;
}
...
/* tag icon */	
.object_tag_string {
	background: url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/icon_tag.gif) no-repeat left 2px;
	padding:0 0 0 14px;
	margin:0;
}	
...
div.ajax_loader {
	background: white url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/ajax_loader_bw.gif) no-repeat center 30px;
	width:auto;
	height:100px;
	margin:0 10px 0 10px;
	-webkit-border-radius: 8px; 
...
a.home-icon:hover{
  background:#000000 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-home.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.home-icon{
  -webkit-border-radius: 4px; 
  -moz-border-radius: 4px;
  background:#F6F6F6 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-home-hover.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.signup-icon:hover{
  background:#000000 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-signup.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.signup-icon{
  -webkit-border-radius: 4px; 
  -moz-border-radius: 4px;
  background:#F6F6F6 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-signup-hover.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.about-icon:hover{
  background:#000000 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-about.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.about-icon{
  -webkit-border-radius: 4px; 
  -moz-border-radius: 4px;
  background:#F6F6F6 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-about-hover.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.myprofile-icon:hover{
  background:#000000 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-myprofile.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.myprofile-icon{
  -webkit-border-radius: 4px; 
  -moz-border-radius: 4px;
  background:#F6F6F6 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-myprofile-hover.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.dashboard-icon:hover{
  background:#000000 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-dashboard.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.dashboard-icon{
  -webkit-border-radius: 4px; 
  -moz-border-radius: 4px;
  background:#F6F6F6 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-dashboard-hover.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.mail-icon:hover{
  background:#000000 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-mail.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.mail-icon{
  -webkit-border-radius: 4px; 
  -moz-border-radius: 4px;
  background:#F6F6F6 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-mail-hover.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.settings-icon:hover{
  background:#000000 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-settings.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
a.settings-icon{
  -webkit-border-radius: 4px; 
  -moz-border-radius: 4px;
  background:#F6F6F6 url(<?php echo $vars['url']; ?>mod/custom_white_theme/graphics/elgg-icons-settings-hover.gif) no-repeat;
  display:block;
  height:60px;
  width:60px;
}
